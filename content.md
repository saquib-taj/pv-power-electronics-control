# Renewable Energy (PV Modelling & Control) Portfolio
...
- [PV Module Modeling](/pv-power-electronics-control/index.html?file=01_PV_Modeling/index.md)
- MPPT (Perturb & Observe)
- Buck converter (open-loop)

## Phase 2: Grid-Connected Inverters
